...
{	
	...
	meshList[GEO_MODEL1] = MeshBuilder::GenerateOBJMTL("model1", "OBJ//house_type01.obj", "OBJ//house_type01.mtl");

	meshList[GEO_MODEL2] = MeshBuilder::GenerateOBJMTL("model2", "OBJ//cottage_obj.obj", "OBJ//cottage_obj.mtl");
	meshList[GEO_MODEL2]->textureID = LoadTGA("Image//cottage_diffuse.tga");
