#include "SceneLightAssignment.h"
#include "GL\glew.h"

#include "shader.hpp"

SceneLightAssignment::SceneLightAssignment()
{
}
...
void SceneLightAssignment::Init()
{	
	...
	meshList[GEO_QUAD] = MeshBuilder::GenerateQuad("floor", Color(0, 1, 0), 10);
...
void SceneLightAssignment::Update(double dt)
{
...
void SceneLightAssignment::Render()
{
	// Render VBO here
...
void SceneLightAssignment::Exit()
{
	// Cleanup VBO here
	for (int i = 0; i < NUM_GEOMETRY; ++i)
	{
...
void SceneLightAssignment::RenderMesh(Mesh* mesh, bool enableLight)
{
